...
global.CONFIG_TESTING_VARS = (0, project_routines_1.setUpTesting)();
const express = require("express");
const SocketServer = require("ws").Server;
const { DEFAULT_PORT, TIME_OUT_SECONDS } = project_constants_1.default;
const PORT = process.env.PORT || DEFAULT_PORT;
const user_connections = {};
const socket_events = (0, socket_events_1.default)(user_connections, game_store_1.default);
...
socket_server.on("connection", (web_socket, req) => {
    ...
    const seconds_connected_at = (0, project_routines_1.dateInSeconds)();
