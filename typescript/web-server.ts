...
import {IConnection, IConnectionArray} from "./types/server-interfaces"
...
const env: IProcessEnv = require("node-env-file")
...
socket_server.on("connection", (web_socket: IWebSocket) => {
